...
<!DOCTYPE html>
<head>
<title>Chào mừng đến với trang quản lí admin</title>
...
<link href="{{asset('pulbic/backend/css/font-awesome.css')}}" rel="stylesheet"> 
<!-- //font-awesome icons -->
...
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/admin-dashboard')}}" method="post">
			...
			<span><input type="checkbox" />Nhớ lần đăng nhập tiếp</span>
